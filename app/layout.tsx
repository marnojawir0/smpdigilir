...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://smpdigilir.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pelajar.`,
        "logo": "https://smpdigilir.pages.dev/favicon.ico",
        "url": "https://smpdigilir.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://smpdigilir.pages.dev"
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://smpdigilir.pages.dev/?q={search_term}", 
